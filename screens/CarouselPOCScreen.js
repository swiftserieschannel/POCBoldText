// import React, { useState, useEffect, useNativeDriver, useRef } from 'react';
// import { StyleSheet, View, Text, TouchableOpacity, Progress, Animated, Easing } from 'react-native';
// import { ProgressBar } from 'react-native-paper'

// const CarouselPOCScreen = () => {
...
//     // useEffect(animateView, [progress])
...
//     // // useEffect(animateView(),[animateView,progress])
...
//             </View>
//             <Animated.Text>{`${progress}%`}</Animated.Text>
//             <Animated.Progress style={{ alignItems: "flex-end",height:5,opacity:1 }} progress={width} color="blue" />
//         </View>
//     );
// };

// CarouselPOCScreen.navigationOptions = navigationData => {
//     return {
//         headerTitle: "Carousel Screen"
//     }
// };
...
// export default CarouselPOCScreen;
...
// class CarouselPOCScreen extends Component {
//     constructor(props) {
//         super(props)
//         this.state = {
...
//     componentDidMount() {
//         setTimeout(() => this.swipingAnimation(width), 3000)
//     }

//     changeWidth = (currentWidth) => {
//         this.swipingAnimation(currentWidth + width)
//     }

//     swipingAnimation = (width) => {
//         const {
//             xValue
//         } = this.state
...
//             duration: 1000,
//             easing: Easing.linear,
//         }).start(() => setTimeout(() => this.changeWidth(width), 3000))
//         // ]).start()
...
//             <Animated.View
//                 style={
//                     { left: xValue, flexDirection: 'row' }
//                 }
//             >
//                 <View style={[animationView, { backgroundColor: 'red' }]} />
//                 <View style={[animationView, { backgroundColor: 'green' }]} />
//                 <View style={[animationView, { backgroundColor: 'blue' }]} />
//                 <View style={[animationView, { backgroundColor: 'pink' }]} />
//                 <View style={[animationView, { backgroundColor: 'black' }]} />
//                 <View style={[animationView, { backgroundColor: 'blue' }]} />
//                 <View style={[animationView, { backgroundColor: 'red' }]} />
//                 <View style={[animationView, { backgroundColor: 'green' }]} />
//                 <View style={[animationView, { backgroundColor: 'blue' }]} />
...
// export class CarouselPOCScreen extends Component {
...
import { StyleSheet, Image, View, Dimensions, Animated, TouchableOpacity, PanResponder } from 'react-native';
...
export default class CarouselPOCScreen extends React.Component {
    ...
    componentWillMount = () => {
        this.panResponder = PanResponder.create({
            onStartShouldSetPanResponder: () => {
                ...
                console.log("pan guesture");
                this.isStart= false
                this.Animation.stopAnimation(value => this.animationValue = value)
    ...
    StartProgressBarAnimation = (value = 0) => {
        ...
        Animated.timing(
            ...
            if(this.isStart){
                // this.Carousel.gotoNextPage(true)
                
                setTimeout(()=> {this.StartProgressBarAnimation()}, 100)
            }
        });
    }
    ...
    render() {
        ...
        return (
            <View style={styles.container} {...this.panResponder.panHandlers}>
                ...
                {/* <Progress.Bar animated={true} progress="0.5" width={null} indeterminate={true} useNativeDriver={true} style={{ marginBottom: 10 }} animationType="timing" /> */}
                {/* <Animated.View style={[styles.progressView, { width: width }]} /> */}
            </View>
        );
    }
}
