...
import { View, Animated, PanResponder, ScrollView, Dimensions, StyleSheet, Easing } from 'react-native';
...
class Carousel extends React.Component {
    ...
    gotoNextPage(animated = true, cb = () => { }) {
        ...
        this.gotoPage(Math.floor(this.currentIndex) + 1, cb);
    }
    ...
    renderIndicator(config) {
        ...
        for (let i = 0; i < pageNum; i++) {
            indicators.push(React.createElement(View, { key: i, style: [styles.pageIndicatorStyle, this.props.pageIndicatorStyle] }));
        }
        ...
        return (React.createElement(View, { style: [styles.pageIndicatorContainerStyle, this.props.pageIndicatorContainerStyle] },
            indicators,
    ...
    render() {
        ...
        this.progressWidth = this.Animation.interpolate(
            {
                inputRange: [0,0.5,1],
        ...
        pages = pages.map((page, index) => {
            return (React.createElement(View, { key: index, style: { width: pageSize } }, page));
        });
        ...
        if (childrenNum < 1) {
            ...
            content = (React.createElement(Animated.View, Object.assign({ style: { flexDirection: 'row', width: pageSize * childrenNum, transform: [{ translateX }] } }, this.panResponder.panHandlers), pages));
        }
        return (React.createElement(View, null,
            React.createElement(ScrollView,
                {
                    ref: ref => this.scrollView = ref, style: { width: pageSize },
                    contentContainerStyle: { width: pageSize + 1 }, horizontal: true,
                    pagingEnabled: true, directionalLockEnabled: true, bounces: false,
                    alwaysBounceHorizontal: false, alwaysBounceVertical: false,
                    showsVerticalScrollIndicator: false,
                    showsHorizontalScrollIndicator: false,
                    scrollEnabled: Platform.OS === 'ios' ? true : false
                },
                <View>{content}<Animated.View style={[styles.progressView, { width: this.progressWidth }]} /></View>),
            this.renderIndicator({ childrenNum, pageNum, loop, scrollValue })));
        //return React.createElement(View,{ style: {backgroundColor:''} },React.createElement(Text,null,["Hellow World"]));
    }
}
